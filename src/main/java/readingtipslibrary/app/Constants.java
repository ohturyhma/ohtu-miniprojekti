...
public class Constants {
    ...
    private static final String TYPE_REMINDER = " (book, blogpost, podcast, video)";
    public static final String FIND_TYPE = "What do you want to find?" ;
    public static final String EDIT_TYPE = "What do you want to edit?" + TYPE_REMINDER;
    public static final String DELETE_TYPE = "What type of tips do you want to delete?" + TYPE_REMINDER;
    public static final String INSERT_TYPE = "What do you want to insert?" + TYPE_REMINDER;
    public static final String DELETE_ONE = "What type of tip do you want to delete?" + TYPE_REMINDER;
}
